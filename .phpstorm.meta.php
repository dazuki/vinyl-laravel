...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./mnt/c/Users/absol/Documents/www/vinyl-laravel/public/storage' => 'string',
...
'excel.imports.properties.keywords','excel.imports.properties.category','excel.imports.properties.manager','excel.imports.properties.company','excel.extension_detector.xlsx',
...
'filesystems.links./mnt/c/Users/absol/Documents/www/vinyl-laravel/public/storage','hashing.driver','hashing.bcrypt.rounds','hashing.argon.memory','hashing.argon.threads',
...
'concurrency.default','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'livewire.upload-file','livewire.preview-file','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','home','artistshow',);
        registerArgumentsSet('views', 
'components.layouts.app','exports.collection','livewire.artist-show','livewire.create-artist','livewire.create-vinyl',
'livewire.header','livewire.login','livewire.vinyl-history','livewire.vinyl-table','livewire::bootstrap',
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap',
'vendor.livewire.simple-tailwind','vendor.livewire.tailwind','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'laravel-exceptions::layout','laravel-exceptions::minimal','livewire-alert::components.flash','livewire-alert::components.scripts','livewire::bootstrap',
...
'APP_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','PHP_CLI_SERVER_WORKERS',
...
'SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','MEMCACHED_HOST',
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','REDIS_PREFIX',
