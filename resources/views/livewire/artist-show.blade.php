    ...
    <div
        ...
        @auth
            <p class="mt-4 mb-2 text-center mx-auto w-full">
                <a class="text-gray-900 rounded-lg border-2 border-green-500 p-2 shadow-md font-semibold bg-slate-100 hover:bg-green-100 w-full"
                    href="/create/vinyl?artist_id={{ $artist->id }}">+ Ny Vinyl</a>
            </p>
        @endauth
