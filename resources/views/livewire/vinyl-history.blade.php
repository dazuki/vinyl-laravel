			...
			<div>
				@auth
					<div class="flex flex-col items-center justify-center">
						<p class="flex justify-between w-full px-2 py-1 text-xs text-center text-red-800 border-0 lg:text-xs lg:w-1/2">
							<span>Vinyler Med Okänt Datum:</span><span class="font-semibold">{{ $vinyler_old }}</span>
						</p>
						<p class="flex justify-between w-full px-2 py-1 text-xs text-center text-emerald-800 lg:text-sm lg:w-1/2">
