			...
			<div
				...
				<div class="hidden lg:flex">
					<ul class="space-x-1 text-sm font-bold lg:flex">
						...
						@auth
							<li><a
									class="menu-btn bg-white transition-colors duration-100 hover:border-green-700 hover:bg-green-50 hover:text-green-700"
									href="/create/vinyl"
									wire:navigate.hover
							...
							<li><a
									class="menu-btn bg-white transition-colors duration-100 hover:border-cyan-700 hover:bg-cyan-50 hover:text-cyan-700"
									href="/create/artist"
									wire:navigate.hover
							...
							<li><a
									class="menu-btn bg-red-50 transition-colors duration-100 hover:border-red-700 hover:bg-red-50 hover:text-red-700"
						...
						@else
							...
							<li><a
									class="menu-btn bg-green-50 transition-colors duration-100 hover:border-green-700 hover:bg-green-50 hover:text-green-700"
