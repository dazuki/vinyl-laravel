<div wire:init="init" class="max-w-screen-xl mx-auto text-left">
    ...
    <div class="relative pt-4">
        <svg class="absolute w-8 svg-icon search-icon bottom-2 left-4 max-sm:left-6 max-sm:w-6"
                        ...
                        <td colspan="2" class="text-center bg-white">
                            <div wire:loading
                                ...
                                <svg aria-hidden="true"
                                    class="w-8 h-8 text-gray-200 animate-spin fill-blue-600 dark:text-gray-600"
