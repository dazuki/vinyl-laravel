  ...
  <div x-data="{ open: false }" class="gradient">
    <div class="container mx-auto flex justify-between items-center p-4 max-w-6xl">
      <div class="text-gray-900 font-bold text-xl sm:text-2xl lg:text-3xl">
        <a href="/" class="antialiased">Vinylskivor Förteckning
          @auth
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5 inline-block text-green-700">
